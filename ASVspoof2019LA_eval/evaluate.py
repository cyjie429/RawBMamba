...
def main():
    ...
    scoreFile = "./model/19.txt"
    labelFile = "/data2/chenyujie/data/ASVspoof2019LA/label/ASVspoof2019.LA.cm.eval.trl.txt"
    asvlabel = "/data2/chenyujie/data/ASVspoof2019LA/label/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt"
